...
function Index(props) {
    ...
    if (props.router.asPath) {
        // console.log({ pageJson: `../content${props.router.asPath.split('?')[0]}.json` });
        try {
            pageJson = require(`../content${decodeURIComponent(
...
function Body(props) {
    return (
        <div className="content center mw6 pa3 pa4-ns">
            ...
            <div dangerouslySetInnerHTML={{ __html: props.bodyHtml }} className="body_wrapper" />
        </div>
    );
}
